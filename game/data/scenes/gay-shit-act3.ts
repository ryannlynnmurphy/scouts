  ...
  beats: [
    ...
    },
    {
      ...
      lines: [
        ...
        { speaker: "quinn", text: "Is it... the flowers. I don't know. What's blue?" },
        { speaker: "matt", text: "Your eyes." },
        { speaker: "quinn", text: "Oh... um." },
      ],
    ...
    // THE EXPOSURE PATH -- Brent followed them to the lake (suspicion >= 0.6)
    {
      ...
      lines: [
        ...
        { speaker: "matt", text: "Brent, it's not--" },
    ...
    },
    {
      ...
      lines: [
        ...
        { speaker: "quinn", text: "You made us kiss earlier! You said it proves we're NOT--" },
    ...
    },
    {
      ...
      location: "LakeScene",
      lines: [
        { speaker: null, text: "(Quinn steps in front of Matt. Shields him with his body.)" },
    ...
    },
    {
      ...
      lines: [
        ...
        { speaker: null, text: "(Quinn looks up and they are still there.)" },
      ],
      nextBeat: "act3-end",
    },
    // Choice 48
    ...
    },
    {
      ...
      lines: [
        ...
        { speaker: "matt", text: "SIMON! What are you confused about?" },
      ],
    ...
    // Pullback / stopped mid-monologue
    {
      ...
      lines: [
        { speaker: "quinn", text: "..." },
        { speaker: "matt", text: "It's okay." },
        { speaker: "quinn", text: "I know." },
    ...
    // Deflected the whole monologue
    {
      ...
      location: "LakeScene",
      lines: [
        { speaker: "matt", text: "You don't have to." },
        { speaker: "quinn", text: "..." },
        { speaker: null, text: "(They sit together under the stars. Matt doesn't push. The moment is smaller than it could have been. But it is still something.)" },
      ],
      nextBeat: "act3-choice51-partial",
    },
