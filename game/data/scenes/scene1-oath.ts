...
export const SCRIPT: SceneScript = {
  ...
  beats: [
    ...
    },
    {
      ...
      nextBeat: "sam-outdoor-code-reaction",
    },
    {
      id: "sam-outdoor-code-reaction",
      location: "CampfireScene",
      lines: [
        { speaker: null, text: "Sam recites the outdoor code perfectly. He's smart. He's brave. He's right there." },
      ],
      choices: [
        {
          id: "oath-look-at-sam-proud",
          text: "(Look at Sam with pride)",
          type: "authentic",
          fractureDelta: -0.01,
          suspicionDelta: 0.02,
          context: "dangerous",
          nextBeat: "outdoor-code-response",
        },
        {
          id: "oath-look-at-brent",
          text: "(Keep your eyes on Brent)",
          type: "performed",
          fractureDelta: 0.01,
          suspicionDelta: -0.01,
          context: "dangerous",
        ...
        {
          id: "oath-look-at-ground",
          text: "(Look at the ground)",
          type: "deflect",
          fractureDelta: 0.01,
          suspicionDelta: 0,
          context: "dangerous",
      ...
      choices: [
        {
          ...
          suspicionDelta: 0.04,
          context: "dangerous",
          nextBeat: "brent-notices-whisper",
        },
        {
          id: "mock-sam-laugh",
    ...
    {
      id: "brent-notices-whisper",
      location: "CampfireScene",
      lines: [
        { speaker: "brent", text: "Simon, you got something to say to your BOYFRIEND over there?" },
        { speaker: "simon", text: "What? No." },
        { speaker: "brent", text: "Then keep your mouth shut." },
      ],
      nextBeat: "sam-steps-back",
