...
export const SCRIPT: SceneScript = {
  ...
  beats: [
    ...
    },
    {
      ...
      location: "VoidScene",
      lines: [
        { speaker: "simon", text: "So I'm researching dolphins for science class, right? Because dolphins are my favorite animal. Well dolphins and mermaids. And butterflies are a close second. Or maybe would that be third. Whatever so, our teacher told us to research our favorite animal and while I wanted to do mermaids, unfortunately \"they don't actually exist.\" Like, okay??? Whatever…" },
        { speaker: "simon", text: "So I'm researching dolphins for science class because I really like dolphins. And I think that it's okay for boys to like dolphins and mermaids and butterflies." },
      ],
    ...
    },
    {
      ...
      location: "VoidScene",
      lines: [
        { speaker: "simon", text: "Okay? I think it's fine that when I go swimming I like to put my legs together and flip them around like they're a mermaid tail. I think that it's fine for me to do that. Because I like mermaids. Okay? And it's okay for boys to like mermaids. SO WHATEVER RIGHT." },
      ],
      choices: [
        {
    ...
    },
    {
      ...
      location: "VoidScene",
      lines: [
        { speaker: "simon", text: "I'm researching dolphins for science class, and I checked out a bunch of books from the library. The librarian asked me, \"would you like a bag?\" I checked out like six books. I couldn't carry them all. Of course, I said yes. I was being practical." },
        { speaker: "simon", text: "She gave me my books in this little tote bag. I think it's very cool. And, I was carrying the tote to school because I needed my books for science class, and they wouldn't fit in my backpack." },
        { speaker: "simon", text: "And, I'm on my morning walk to school, and these guys passed me. It was this big red truck. There was a bunch of older boys, and they screamed out the window \"FAGGOT.\"" },
      ],
    ...
    },
    {
      ...
      location: "VoidScene",
      lines: [
        { speaker: "simon", text: "I wish I could just be a tomato, so the guys at school wouldn't pick on me." },
      ],
      choices: [
        {
    ...
    },
    {
      ...
      location: "VoidScene",
      lines: [
        { speaker: "simon", text: "Now, I walk down the hallways and think \"Ooo maybe I should walk different. I'm walking like a fag.\" \"Why are you moving your hips like that, faggot?\" \"Why are you moving your arms like that, faggot.\" \"Hey faggot. No one wants you to act like that. No one wants you to be yourself.\"" },
        { speaker: "simon", text: "…I wish I could just be myself. You know everyone keeps saying, just be yourself. Be yourself!" },
        { speaker: "simon", text: "Who is \"yourself?\"" },
      ],
